...
/*****************LIFTER**********************/
bool flag3 = LOW;
bool lifterflag1 = LOW;
int lifter_photo_count = 0;
/******************LIFTER*******************/
...
void loop() {
  ...
  if (voltage > 0.1 && lifterflag1 == LOW && lifter_photo_count == 0) {
    flag3 = LOW;
  ...
  if (menu == LOW && menuflag == LOW) {
    ...
    menu_count++;
    if (menu_count >= 11) menu_count = 0;

    menuflag = HIGH;
  }
  if (menu == HIGH) menuflag = LOW;
  /******************************************************************/
  switch (menu_count) {
    case 0:
      oled_display();
    ...
    case 1:
      ...
      if (up == HIGH) upflag = LOW;

      if (down == LOW && downflag == LOW) {

        in_count--;
        if (in_count == -1) in_count = 0;

        downflag = HIGH;
      }
      if (down == HIGH) downflag = LOW;
    ...
    case 3:
      ...
      if (down == LOW && downflag == LOW) {
        ...
        cutter_delay = cutter_delay - 50;
        if (cutter_delay == -50) cutter_delay = 0;
    ...
    case 6:
      ...
      if (down == LOW && downflag == LOW) {
        ...
        in_count_suction--;
        if (in_count_suction == -1) in_count_suction = 0;
    ...
    case 7:
      ...
      if (down == LOW && downflag == LOW) {
        ...
        out_count_suction--;
        if (out_count_suction == -1) out_count_suction = 0;
    ...
    case 8:
      ...
      if (down == LOW && downflag == LOW) {
        ...
        suction_delay = suction_delay - 50;
        if (suction_delay == -50) suction_delay = 0;
  ...
  /**********************************************CUTTER******************************************************/
  if (pulse == in_count && solenoid_flag == false && start_cut == HIGH && photo_flag == true && lifterflag1 == LOW && lifter_photo_count == 0) {
    solenoid_flag = true;

    lifter_photo_count += 1;
    lifterflag1 = HIGH;
  ...
  if (pulse == out_count && solenoid_flag == false && end_cut == HIGH && photo_flag == false  && lifterflag1 == LOW && lifter_photo_count == 0) {
    solenoid_flag = true;
  ...
  if (photo_flag == false && lifter_photo_count == 1) {
    lifter_photo_count += 1;
  }
  if (lifterflag1 == HIGH && photo_flag == true && lifter_photo_count == 2) {
    lifterflag1 = LOW;
    lifter_photo_count = 0;
    digitalWrite(lifter_solenoid_pin, LOW);
    delay(1);
    digitalWrite(relay, LOW);
    delay(1);
  ...
  /*****************************************SUCTION_PEDAL***********************************************************/
  if (voltage > 0.60 && suction_solenoid_flag1 == false && start_suction == HIGH && photo_flag == true && suction_flag_one == LOW) {
...
void oled_display() {
  ...
  if (start_cut == LOW) oled.print("OFF");
  if (start_cut == HIGH) oled.print("ON");

  oled.setCursor(2, 52);  // x y set position to display
  oled.print("END CUT     - ");
  if (end_cut == LOW) oled.print("OFF");
  if (end_cut == HIGH) oled.print("ON");
...
void oled_display_1() {
  ...
  if (start_suction == LOW) oled.print("OFF");
  if (start_suction == HIGH) oled.print("ON");

  oled.setCursor(2, 52);  // x y set position to display
  oled.print("SUC END     - ");
  if (end_suction == LOW) oled.print("OFF");
  if (end_suction == HIGH) oled.print("ON");
